...
class UnifiedScoring(KeyedProcessFunction):
    ...
    def get_features_r7(self, userstats, amount, user_id):
...
# -------------------
    ...
    # -------------------
        ...
        # Rule 4: First-time high-value transaction with a merchant (nameOrig, nameDest and amount)
            ...
            # total_txn is same as last count hence already increased by 1 in previuos rule
    ...
    # -------------------
        ...
        # Rule 7: Same Amount Multiple Times
            ...
            # Trasnform Data:
            current_count, total_count = self.get_features_r7(userstats, amount)
            current_count += 1
